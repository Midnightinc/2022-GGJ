...
namespace AbilitySystem
{
    ...
    [CreateAssetMenu(fileName = "Example", menuName = "Abilities/Speed Increase", order = 1)]

    /// <summary>
    /// Example ability is an outline or boiler plate for what could be an ability class
    /// </summary>
    public class SpeedIncrease : WeaponModifier
    {
        /// <summary>
        ...
        private void SpeedAbilityAdded(WeaponAbilityComponent obj, bool isAI)
        {
            obj.GetComponent<IAtributeIncrease>().IncreaseSpeed(0.5f);
        }
